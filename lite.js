...
function getApiConfig() {
  ...
  return {
    ...
    liteWriteToken: getCompatEnv(["LITE_API_WRITE_TOKEN"], ["PUBLIC_API_WRITE_TOKEN", "SESSION_SECRET"], "", { allowFallbacks: allowLegacyFallbacks }),
...
function validateApiConfig(config = getApiConfig()) {
  ...
  if (isProd && !config.liteWriteToken) {
    errors.push("LITE_API_WRITE_TOKEN is required in production.");
  }
